...
3. `docs/rules/<ruleId>.md` を [docs/rules/kh-leader-double.md](./rules/kh-leader-double.md) のテンプレートに
   従って作成する（**ルールごとに1ファイル**）。
...
- `docs/rules/` のファイル名は `ruleId` と一致させる（例 `kh-leader-double` → `docs/rules/kh-leader-double.md`）。
